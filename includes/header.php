...
<body>
    <div class="d-flex flex-row " id="wrapper">
        ...
        <div class="secondary-bg " id="sidebar-wrapper">
            <div class="sidebar-heading  text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">Planet Dev</div>
            <div class="list-group list-group-flush my-3">
                ...
                <a href="articlePage.php" class="list-group-item list-group-item-action bg-transparent text-dark active"><i class="fas fa-tachometer-alt me-2"></i>Artciles</a>
                <a href="categoryPage.php" class="list-group-item list-group-item-action bg-transparent text-dark active"><i class="fas fa-tachometer-alt me-2"></i>Categories</a>
